...
def normalize_math_for_streamlit(text: str) -> str:
    """
    Normalize common LaTeX formats generated by LLMs
    so Streamlit can render mathematical expressions correctly.
    """
    ...
    # ---------------------------------------------------------
    # 4. Convert standalone [ LaTeX ] equations to $$ ... $$
    #
    # Example:
    # [ \boxed{ ... } ]
    # becomes:
    ...
    for line in lines:
        ...
        # Detect lines that look like standalone LaTeX equations
        latex_indicators = (
            r"\mathbf",
            r"\operatorname",
            r"\text{",
        ...
        # Don't touch lines that are already correctly formatted
        already_math = (
            stripped.startswith("$$")
        ...
        # -----------------------------------------------------
        # Convert [ ... ] containing LaTeX into display math
        # -----------------------------------------------------
        if (
            contains_latex
...
for message in visible_messages:
    ...
    with st.chat_message(role):
        ...
        if role == "assistant":
            content = normalize_math_for_streamlit(content)
